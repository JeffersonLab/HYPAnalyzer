#ifndef HYPSpacePoint_h
#define HYPSpacePoint_h

#include "TObject.h"
#include "HYPDCHit.h"

class HYPSpacePoint : public TObject {
...
public:
  ...
  HYPDCHit* GetHit(Int_t ihit) {return fHits[ihit].dchit;};
  //  std::vector<HYPDCHit*>* GetHitVectorP() {return &fHits;};
  //std::vector<Hit>* GetHitStuffVectorP() {return &fHits;};
  void ReplaceHit(Int_t ihit, HYPDCHit *hit) {

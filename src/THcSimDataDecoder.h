#ifndef THCSIMDATADECODER_H
#define THCSIMDATADECODER_H
...
class THcSimDataDecoder {
public:
  THcSimDataDecoder(const char *enc_name, unsigned short enc_id);
  virtual ~THcSimDataDecoder() {};
  ...
  */
  ...
  static THcSimDataDecoder* GetEncoderByName(const char *enc_name);
  static THcSimDataDecoder* GetEncoder(unsigned short id);
...
private:
  static std::vector<THcSimDataDecoder*> fEncoders;
};

// Generic TDC encoder
class THcSimTDCEncoder : public THcSimDataDecoder {
public:
  THcSimTDCEncoder(const char *enc_name, unsigned short enc_id,
      unsigned short bits, unsigned short edge_bit);
  virtual ~THcSimTDCEncoder() {};
...
// Generic ADC encoder
class THcSimADCEncoder : public THcSimDataDecoder {
public:
  THcSimADCEncoder(const char *enc_name, unsigned short enc_id,
      unsigned short bits);
  virtual ~THcSimADCEncoder() {};
...
class THcSimSADCEncoder : public THcSimADCEncoder {
public:
  THcSimSADCEncoder(const char *enc_name, unsigned short enc_id);
  virtual ~THcSimSADCEncoder() {};
...
class THcSimFADC250Encoder : public THcSimADCEncoder {
public:
  THcSimFADC250Encoder(const char *enc_name, unsigned short enc_id);
  virtual ~THcSimFADC250Encoder() {};
...
// MPD
class THcSimMPDEncoder : public THcSimDataDecoder {
public:
  THcSimMPDEncoder(const char *enc_name, unsigned short enc_id);
  virtual ~THcSimMPDEncoder() {};

...
namespace Decoder {
  ...
  class THcSimTDC : public PipeliningModule {   // Inheritance

  public:

    THcSimTDC();                         // Default constructor
    THcSimTDC(Int_t crate, Int_t slot);  // Constructor
    virtual ~THcSimTDC();                // Virtual constructor
  ...
  private:
    ...
    ClassDef(THcSimTDC,0)  //  Generic SimTDC module

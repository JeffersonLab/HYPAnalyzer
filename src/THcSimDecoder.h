#ifndef __THcSimDecoder_h
#define __THcSimDecoder_h
...
#include "THcSimFile.h"//needed for THcSimEvent
#include "TH1D.h"
...
class THaDetMap;
class THcSimSADCEncoder; // For decoding simulation GEMs
//class TDetInfo;

//-----------------------------------------------------------------------------
// SBS digitized simulation decoder class
class THcSimDecoder : public Podd::SimDecoder {
 public:
...
protected:
  ...
  THcSimSADCEncoder *fDecoderMPD;//FIXME: a bit of a kludge... 
